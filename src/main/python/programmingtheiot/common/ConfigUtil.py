...
class ConfigUtil(metaclass=Singleton):
    ...
    def getProperty(
        self, section: str, key: str, defaultVal: str = None, forceReload: bool = False
    ):
        """
    ...
    def getInteger(
        self, section: str, key: str, defaultVal: int = 0, forceReload: bool = False
    ):
        """
    ...
    def getFloat(
        self, section: str, key: str, defaultVal: float = 0.0, forceReload: bool = False
    ):
        """
