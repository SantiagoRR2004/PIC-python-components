...
TEST_ACTUATOR_NAME = "TestActuator"
...
CDA_UPDATE_NOTIFICATIONS_MSG_RESOURCE = (
    PRODUCT_NAME + "/" + CONSTRAINED_DEVICE + "/" + UPDATE_NOTIFICATIONS_MSG
)
...
CDA_REGISTRATION_REQUEST_RESOURCE = (
    PRODUCT_NAME + "/" + CONSTRAINED_DEVICE + "/" + RESOURCE_REGISTRATION_REQUEST
)
...
GRADE_SIM_FLOOR_KEY = "gradeSimFloor"
GRADE_SIM_CEILING_KEY = "gradeSimCeiling"
